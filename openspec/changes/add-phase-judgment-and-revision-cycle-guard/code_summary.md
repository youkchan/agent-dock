...
### code_unit_1
- file: team_orchestrator/models.py
- service: task-model
- function: phase-judgment-model
- purpose: `pass|changes_required|blocked` 判定値を扱うモデルを定義する。
- input: phase 実行結果
- output: 正規化済み判定値
- error: 未知判定値は不正入力扱い
...
### code_unit_2
- file: team_orchestrator/orchestrator.py
...
### code_unit_2
- file: team_orchestrator/state_store.py
- service: state-store
...
### code_unit_1
- file: tests/test_orchestrator.py
- service: orchestrator-regression-test
